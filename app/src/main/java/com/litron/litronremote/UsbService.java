...
public class UsbService extends Service {
    ...
    public static final String ACTION_USB_READY = "com.litron.litronremote.connectivityservices.USB_READY";
    public static final String ACTION_USB_ATTACHED = "android.hardware.usb.action.USB_DEVICE_ATTACHED";
    public static final String ACTION_USB_DETACHED = "android.hardware.usb.action.USB_DEVICE_DETACHED";
    public static final String ACTION_USB_NOT_SUPPORTED = "com.litron.litronremote.usbservice.USB_NOT_SUPPORTED";
    public static final String ACTION_NO_USB = "com.litron.litronremote.usbservice.NO_USB";
    public static final String ACTION_USB_PERMISSION_GRANTED = "com.litron.litronremote.usbservice.USB_PERMISSION_GRANTED";
    public static final String ACTION_USB_PERMISSION_NOT_GRANTED = "com.litron.litronremote.usbservice.USB_PERMISSION_NOT_GRANTED";
    public static final String ACTION_USB_DISCONNECTED = "com.litron.litronremote.usbservice.USB_DISCONNECTED";
    public static final String ACTION_CDC_DRIVER_NOT_WORKING = "com.litron.litronremote.connectivityservices.ACTION_CDC_DRIVER_NOT_WORKING";
    public static final String ACTION_USB_DEVICE_NOT_WORKING = "com.litron.litronremote.connectivityservices.ACTION_USB_DEVICE_NOT_WORKING";
